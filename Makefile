...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Aug 7 04:57:10 2017
# Project:  Tarot.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/tarotQt1.0.0/ && $(COPY_FILE) --parents src/AI.hpp src/Announcements.hpp src/Beginner.hpp src/Biddings.hpp src/Card.hpp src/CardItem.hpp src/Deck.hpp src/Game.hpp src/getChar.hpp src/getInt.hpp src/Human.hpp src/Player.hpp src/StratDiff.hpp src/StratLang.hpp src/Suits.hpp src/TarotScene.hpp src/Team.hpp src/Trick.hpp obj/tarotQt1.0.0/ && $(COPY_FILE) --parents src/AI.cpp src/Beginner.cpp src/Card.cpp src/CardItem.cpp src/Deck.cpp src/Game.cpp src/getChar.cpp src/getInt.cpp src/Human.cpp src/main.cpp src/Player.cpp src/TarotScene.cpp src/Team.cpp src/Trick.cpp obj/tarotQt1.0.0/ && (cd `dirname obj/tarotQt1.0.0` && $(TAR) tarotQt1.0.0.tar tarotQt1.0.0 && $(COMPRESS) tarotQt1.0.0.tar) && $(MOVE) `dirname obj/tarotQt1.0.0`/tarotQt1.0.0.tar.gz . && $(DEL_FILE) -r obj/tarotQt1.0.0
...
obj/CardItem.o: src/CardItem.cpp src/CardItem.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/CardItem.o src/CardItem.cpp
