...
\begin{DoxyCompactList}\small\item\em In a 5-\/player game, to choose as a partner the player having the called king (or card). \end{DoxyCompactList}\item 
...
\hypertarget{classGame_a584bfe348c8e1128dbb4b1fb40a05f0b}{\index{Game@{Game}!Game@{Game}}
\index{Game@{Game}!Game@{Game}}
\subsubsection[{Game}]{\setlength{\rightskip}{0pt plus 5cm}Game\-::\-Game (
\begin{DoxyParamCaption}
\item[{int \&}]{number\-Players, }
\item[{const string}]{your\-Name = {\ttfamily \char`\"{}You\char`\"{}}, }
\item[{const bool}]{automatic = {\ttfamily false}}
\end{DoxyParamCaption}
)}}\label{classGame_a584bfe348c8e1128dbb4b1fb40a05f0b}
...
\hline
{\em automatic} & A boolean set to true if and only if one wants to perform automatic tests (4 bots playing together). False by default. \\
\hline
\end{DoxyParams}
...
\subsubsection[{compute\-Score}]{\setlength{\rightskip}{0pt plus 5cm}double Game\-::compute\-Score (
\begin{DoxyParamCaption}
...
\subsubsection[{same\-Team}]{\setlength{\rightskip}{0pt plus 5cm}bool Game\-::same\-Team (
\begin{DoxyParamCaption}
